...
urlpatterns = [
    ...
    path('course/<int:course_id>/review/', views.rate_course, name='rate_course'),
    path('course/<int:course_id>/lesson/<int:lesson_id>/', views.watch_lesson, name='watch_lesson'),
    path('lesson/<int:lesson_id>/comment/', views.add_lesson_comment, name='add_lesson_comment'),
    path('comment/<int:comment_id>/delete/', views.delete_lesson_comment, name='delete_lesson_comment'),
